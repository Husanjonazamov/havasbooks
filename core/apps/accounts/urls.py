...
from .views import RegisterView, ResetPasswordView, MeView, ChangePasswordView, CreateUserFromTokenView
...
urlpatterns = [
    ...
    path("auth/test/", CreateUserFromTokenView.as_view(), name="test"),
    path(
        "auth/token/refresh/",
